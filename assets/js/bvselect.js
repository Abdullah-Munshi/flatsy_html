...
class BVSelect {
    ...
    constructor({
        ...
        this.SetupListOptions = function () {
                ...
                item.addEventListener('click', (e) => {
                    ...
                    if (item.classList.contains("bv_disabled") || item.classList.contains("nofocus") || item.classList.contains("bv_separator")) { } else {
                        if (selected_option.attributes.multiple) {
                            ...
                            // MODIFICATION
                            document.getElementById("ul_" + randomID).style.opacity = "0";
                            document.getElementById("ul_" + randomID).style.visibility = "hidden";
            ...
            document.querySelector('#bv_' + randomID).addEventListener('mouseenter', function () {
                document.getElementById("ul_" + randomID).style.opacity = "1";
                document.getElementById("ul_" + randomID).style.visibility = "visible";
            })
            document.querySelector('#bv_' + randomID).addEventListener('mouseleave', function () {
                document.getElementById("ul_" + randomID).style.opacity = "0";
                document.getElementById("ul_" + randomID).style.visibility = "hidden";
            })
        }
